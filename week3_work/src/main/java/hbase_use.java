...
public class hbase_use {

    public static void main(String[] args) throws IOException {
        // 建立连接docker run -d -p 2181:2181 -p 60000:60000 -p 60010:60010 -p 60020:60020 -p 60030:60030 --name geektime_hbase --hostname geektime_hbase satoshiyamamoto/hbase:2.1
        Configuration configuration = HBaseConfiguration.create();
        configuration.set("hbase.zookeeper.quorum", "127.0.0.1");
        configuration.set("hbase.zookeeper.property.clientPort", "2181");
        configuration.set("hbase.master", "127.0.0.1:60000"); // bug连不上，配置C:\Windows\System32\drivers\etc\host文件，127.0.0.1 edef6a0b303d
